...
ParmOff(model,
        ...
        .logged = "z",
        .verbose = TRUE)
# Lower limit imposed on 'x': before: -1, after: 0
# Upper limit imposed on 'y': before: 20, after: 10
# ParmUnLog (log10) applied to 'z': before: 1, after: 10
# Used arguments: x y z
